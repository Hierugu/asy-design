        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              <h2 className="text-2xl font-semibold text-gray-900 mb-6">Как с нами связаться</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@asydesign.ru</p>
                    <p className="text-gray-600">sales@asydesign.ru</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">БЦ "Современный", офис 456</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 mb-1">Режим работы</h3>
