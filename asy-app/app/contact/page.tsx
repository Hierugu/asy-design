    ...
    <main className="min-h-screen bg-[var(--background)] py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Contact Info */}
          <div>
            <div className="bg-[var(--background-content)] rounded-lg shadow-sm p-6 mb-6">
              <h2 className="text-2xl font-semibold text-[#2D3436] mb-6">Как с нами связаться</h2>
              
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="w-10 h-10 bg-[var(--icon-background)] rounded-full flex items-center justify-center mr-4 shrink-0">
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  id="name"
                  className="w-full px-4 py-2 bg-[var(--form-background)] border-2 border-[var(--form-border)] rounded-lg focus:ring-2 focus:ring-[#D8A318] focus:border-[var(--form-border)]"
              ...
              <div>
                ...
                <textarea
                  id="message"
                  rows={5}
                  className="w-full px-4 py-2 bg-[var(--form-background)] border-2 border-[var(--form-border)] rounded-lg focus:ring-2 focus:ring-[#D8A318] focus:border-[var(--form-border)] resize-none"
